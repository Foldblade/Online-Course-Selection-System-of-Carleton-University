...
![登录页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606185925218.png)

除登录页、关于页外的所有页面均需登陆后方可访问。如未登陆而访问了除登录页、关于页外的页面，将会跳转到登录页。

在登陆页可选是否保持登录状态。若登录失败会出现失败提示，失败超过三次将会在24小时内禁止登录。

![登录页2](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606190227772.png)

### 课程库（首页）

登陆成功后将会自动跳转到首页。首页无论是学生或教学秘书都可访问。

![课程库（首页）](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606192731898.png)

在首页可以按条件进行课程的查询。

![课程库（首页）2](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606192833888.png)
...
![课程详情页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606192928126.png)

### 我的选课页

该页面仅学生可以访问。

![我的选课页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606193404698.png)
...
![选课结果页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606195907475.png)

![选课结果页2](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606200421860.png)

### 选课审核页

该页面仅教学秘书可访问。

![选课审核页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606200322236.png)
...
![已审核列表页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606200758289.png)
...
![课程管理页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606201111925.png)

![课程管理页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606201237578.png)
...
![编辑课程页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606201420003.png)
...
![账号管理页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606201510430.png)

![账号管理页2](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606201526802.png)

![账号管理页3](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606201542340.png)

![账号管理页4](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606201559978.png)

### 关于页

对本系统所用外部资源的致谢。

![关于页](E:\xampp\htdocs\PHPCourse\CourseProject\ReadMe.assets\image-20200606201715082.png)
